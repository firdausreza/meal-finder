  ...
  render() {
    this.shadowDOM.innerHTML = `
      ...
      <article id="meal" class="relative cursor-pointer w-44 h-44 text-center">
        ...
        <div id="meal-info" data-mealID="meal.idMeal" class="absolute top-0 left-0 w-full h-full rounded-lg bg-black bg-opacity-75 flex items-center justify-center transition-opacity opacity-0 hover:opacity-100">
